...
/*
  ...
  public String crud(Map<String, Object> model) {
    try (Connection connection = dataSource.getConnection()) {
      ...
      stmt1.executeUpdate(
          "INSERT INTO adresse(code_postal, num, pays, rue, ville) VALUES ('75116', '31', 'FRANCE', 'RUE GREUZE', 'PARIS')");
      ...
      stmt2.executeUpdate(
          "INSERT INTO consommateur(email, mot_de_passe, nom, prenom, telephone, adresse_id) VALUES ('simonweb98@gmail.com', 'mdp', 'weber', 'simon', '0674653955', 2)");
      stmt2.executeUpdate(
          "UPDATE consommateur SET email='simonweb98@free.fr' WHERE email='simonweb98@gmail.com'");
      stmt2.executeUpdate(
          "INSERT INTO consommateur(email, mot_de_passe, nom, prenom, telephone, adresse_id) VALUES ('thomas@gmail.com', 'mdp', 'weber', 'thomas', '0674653955', 3)");
